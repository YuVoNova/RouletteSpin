...
{
    public class ButtonSpinScript : ButtonBaseScript, INextSpinListener, IResetListener
    {
        ...
        private void Awake()
        {
            _buttonEvent = ButtonEvent.Spin;

            _inMove = GetComponent<RectTransform>().offsetMax.x;
